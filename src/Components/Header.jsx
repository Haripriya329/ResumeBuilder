      ...
      <AppBar position="static">
        <Toolbar>
            ...
            <IconButton
              ...
              sx={{ mr: 2 }}
            >
             <img src="https://static.vecteezy.com/system/resources/thumbnails/024/235/881/small_2x/cv-icon-resume-illustration-sign-user-data-symbol-or-logo-vector.jpg" style={{ height: "10px" }} 
             alt="" />
            </IconButton>
         ...
         <Tooltip title={ProjectIntro} > <Button sx = {{fontWeight:'600'}} color="inherit">About Us</Button></Tooltip>
        </Toolbar>
      </AppBar>
    </Box>
  )
